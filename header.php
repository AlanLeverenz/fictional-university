          ...
          <div class="site-header__menu group">
            <nav class="main-navigation">
              <ul>
                ...
                <li <?php if (get_post_type() == 'event' OR is_page('past-events')) echo 'class="current_menu_item"'; ?>><a href="<?php echo get_post_type_archive_link('event')?>">Events</a></li>
            ...
            <div class="site-header__util">
              ...
              <a <?php echo esc_url(site_url('/search')) ?> class="search-trigger js-search-trigger"><i class="fa fa-search" aria-hidden="true"></i></a>
            </div>
          </div>
        </div>
      </header>
